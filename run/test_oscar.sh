...
# OSCAR Testing Script


echo "Starting OSCAR Testing..."
...
# Add current directory to Python path and run O testing
PYTHONPATH="$MAIN_DIR:$PYTHONPATH" python3 train_test_oscar.py

echo "OSCAR Testing completed!"
